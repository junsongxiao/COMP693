...
class Bookings:
    ...
    def insert_or_update_quote(booking_id, adult_quote, child_quote, infant_quote, family_quote, notes):
        ...
        update_query = """
            ...
            WHERE BookingID = %s
        """
        success=database_execute_action(update_query, (adult_quote, child_quote, infant_quote, family_quote, notes, booking_id))
        print(success)
        return success
        
    @staticmethod
    def assign_agent_to_booking(booking_id, agent_id):
        query = "UPDATE Bookings SET AgentID = %s WHERE BookingID = %s"
        return database_execute_action(query, (agent_id, booking_id))
